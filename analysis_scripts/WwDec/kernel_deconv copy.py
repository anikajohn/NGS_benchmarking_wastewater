...
class DataPreprocesser:
    ...
    #modification made by Anika, needed to make it mor general for different prefixes of the frac coloumn
#     def More_general_preprocess(
#         self,
#         variants_list,
#         variants_pangolin,
#         variants_not_reported,
...
#         #ADDITION: look at all coloumns with frac 
#         sub_set = [item for item in list(self.df_tally.columns) if item.startswith('frac')] + ["date"]
      
#         # drop rows without estimated frac or date
#         self.df_tally.dropna(subset=sub_set, inplace=True)
#         # create column with mutation signature
#         self.df_tally["mutations"] = (
#             self.df_tally["pos"].astype(str) + self.df_tally["base"]
#         )
